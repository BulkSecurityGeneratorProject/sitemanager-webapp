...
import net.systemexklusiv.sitemanager.domain.PersistentToken;
import net.systemexklusiv.sitemanager.domain.User;
import net.systemexklusiv.sitemanager.repository.PersistentTokenRepository;
...
import net.systemexklusiv.sitemanager.service.MailService;
import net.systemexklusiv.sitemanager.service.UserService;
import net.systemexklusiv.sitemanager.web.rest.dto.KeyAndPasswordDTO;
import net.systemexklusiv.sitemanager.web.rest.dto.ManagedUserDTO;
import net.systemexklusiv.sitemanager.web.rest.dto.UserDTO;
