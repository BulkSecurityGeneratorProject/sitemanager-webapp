...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "SiteManager@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "SiteManager API";

        private String description = "SiteManager API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "SiteManager";
