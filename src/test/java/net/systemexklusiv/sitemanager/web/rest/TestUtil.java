...
import static net.systemexklusiv.sitemanager.config.JacksonConfiguration.ISO_DATE_OPTIONAL_TIME;
import static net.systemexklusiv.sitemanager.config.JacksonConfiguration.ISO_FIXED_FORMAT;
